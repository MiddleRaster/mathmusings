...
There are two different cases: either the team has figured out that low WIP limits are crucial to short response times, or they haven't figured out WIP at all and are running without them or they're set way too high.

1. If you don't have WIP limits
...
3. If your WIP limits are all set to 1 (per worker)
...
Suppose your team has figured out that WIP limits are critical to keeping your response times short (a.k.a., cycle time).
In fact, let's say that the WIP limits are all set to "1".
