...
We can find an overly large rectangle that encompasses the actual area; 
it's a rectangle formed from the upper-left point \\((1,1)\\)
to the lower-right point \\((1+x,0).\\)
We can also find a too small rectangle by using the other end of the 1/x curve; 
it's the rectangle from the upper-right point \\((1+x, 1/(1+x))\\) to the lower-left point \\((1,0).\\)
