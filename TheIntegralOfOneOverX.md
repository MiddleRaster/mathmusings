...
We can find an overly large rectangle that encompasses the actual area; it's a rectangle formed from by upper-left point \\((1,1)\\)
and the lower-right point \\((1+x,0).\\)
