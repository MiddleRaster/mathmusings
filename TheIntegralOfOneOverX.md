...
\\[
N(m)\cdot N(n) = [10^{7}(1 - \frac{1}{10^{7}})^m]\cdot [10^{7}(1 - \frac{1}{10^{7}})^n].
\\]

Simplify:

\\[
N(m)\cdot N(n) = 10^{14}(1 - \frac{1}{10^{7}})^{m+n}.
\\]

Compare with \(N(m+n)\):

\\[
N(m+n) = 10^{7}(1 - \frac{1}{10^{7}})^{m+n}.
\\]

So we have the relation:
\\[
N(m)\cdot N(n) = 10^{7}\cdot N(m+n).
\\]
